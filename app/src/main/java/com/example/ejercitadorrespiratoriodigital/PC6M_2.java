...
public class PC6M_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pc6_m2);
    ...
    private void startChronometer(){
        countDownTimer=new CountDownTimer(segTot,1000) {
            ...
            public void onFinish() {
                usuario.afterOx= (int) (oxiAcum/i);
                Intent intentPC6M3 = new Intent(getApplicationContext(),PC6M_3.class);
                startActivity(intentPC6M3);
